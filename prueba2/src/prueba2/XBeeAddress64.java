...
public class XBeeAddress64 extends XBeeAddress {
	...
	public static final XBeeAddress64 BROADCAST = new XBeeAddress64(new int[] {
			0, 0, 0, 0, 0, 0, 0xff, 0xff });
	public static final XBeeAddress64 ZNET_COORDINATOR = new XBeeAddress64(
			new int[] { 0, 0, 0, 0, 0, 0, 0, 0 });

	private int[] address;

	/**
	 * Parses an 64-bit XBee address from a string representation Must be in the
	 * format "## ## ## ## ## ## ## ##" (i.e. don't use 0x prefix)
	 * 
	 * @param addressStr
	 */
	 ...
	 *            LSB
	 */
	public XBeeAddress64(int b1, int b2, int b3, int b4, int b5, int b6,
			int b7, int b8) {
		address = new int[8];
	...
	public void setAddress64(String addressStr) {
		StringTokenizer st = new StringTokenizer(addressStr, " ");
	...
	public void setAddress(int b1, int b2, int b3, int b4, int b5, int b6,
			int b7, int b8) {
		address = new int[8];
