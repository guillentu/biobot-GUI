...
public class XBeeAddress16 extends XBeeAddress {
	...
	public void setAddress16(int msb, int lsb) {
		this.doubleByte.setMsb(msb);
		this.doubleByte.setLsb(lsb);
	}
	
	public void setAddress16(String addressStr) {
		StringTokenizer st = new StringTokenizer(addressStr, " ");
		
		String byteStr = st.nextToken();
		this.doubleByte.setLsb(Integer.parseInt(byteStr, 16));
		System.out.println("\nBytes" + byteStr + "-" +Integer.parseInt(byteStr, 16));
		byteStr = st.nextToken();
		this.doubleByte.setMsb(Integer.parseInt(byteStr, 16));
		System.out.println("\nBytes" + byteStr+ "-" +Integer.parseInt(byteStr, 16));
	}
